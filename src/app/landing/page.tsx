...
export default function LandingPage() {
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      {/* Nav */}
      <nav className="sticky top-0 z-50 flex items-center justify-between bg-white/80 backdrop-blur-sm px-4 py-4 sm:px-6">
      ...
      <section className="max-w-4xl mx-auto px-4 pt-12 pb-12 text-center sm:px-6 sm:pt-20 sm:pb-16">
        ...
        <h1 className="text-3xl font-bold text-gray-900 leading-tight sm:text-5xl">
          Turn your inbox into an
          <br />
          <span className="text-blue-600">organized task board</span>
        </h1>
        <p className="mt-4 text-base text-gray-600 max-w-2xl mx-auto sm:mt-6 sm:text-lg">
        ...
        <div className="mt-8 flex flex-col items-center gap-3 sm:mt-10 sm:flex-row sm:justify-center sm:gap-4">
          <Link
            href="/auth/signup"
            className="flex w-full items-center justify-center gap-2 px-6 py-3 text-base font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors shadow-lg shadow-blue-200 sm:w-auto"
          >
            Get started free <ArrowRight className="h-4 w-4" />
          </Link>
          <Link
            href="/auth/signin"
            className="w-full px-6 py-3 text-base font-medium text-gray-700 bg-white hover:bg-gray-50 rounded-lg transition-colors border sm:w-auto"
          >
            Log in
          </Link>
        </div>
